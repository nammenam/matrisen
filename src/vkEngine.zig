...
fn init_instance(self: *Self) void {
    ...
    self.debug_messenger = instance.debug_messengera
}
...
fn load_textures(self: *Self) void {
    const lost_empire_image = texs.load_image_from_file(self, "assets/wl.png") catch @panic("Failed to load image");
...
fn load_meshes(self: *Self) void {
    ...
    var monkey_mesh = mesh_mod.load_from_obj(self.allocator, "assets/sphere.obj");
    ...
    var lost_empire = mesh_mod.load_from_obj(self.allocator, "assets/cube.obj");
